  ...
  return (
    <main className="min-h-screen bg-[#0c0c1d] text-white font-sans overflow-x-hidden">
      ...
      <div className="flex justify-center gap-6 py-8 border-t border-white/5">
        <a href="https://www.instagram.com/olfly.app/" target="_blank" rel="noopener noreferrer" aria-label="Follow Olfly on Instagram" className="text-white/50 hover:text-white transition-colors">
        ...
        <a href="https://www.facebook.com/profile.php?id=61580709514176" target="_blank" rel="noopener noreferrer" aria-label="Follow Olfly on Facebook" className="text-white/50 hover:text-white transition-colors">
          <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
          </svg>
        </a>
        <a href="https://www.linkedin.com/company/olfly-app" target="_blank" rel="noopener noreferrer" aria-label="Follow Olfly on LinkedIn" className="text-white/50 hover:text-white transition-colors">
          <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
