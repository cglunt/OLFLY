      ...
      <div className="p-6 pb-24 space-y-6">
        ...
        <div className="bg-[#3b1645] rounded-2xl p-5 space-y-3">
          ...
          <div className="space-y-2 text-sm text-white/60">
            ...
            <p>
              Rest phase sound by <a href="https://pixabay.com/users/gigidelaromusic-51134264/" target="_blank" rel="noopener noreferrer" className="text-[#ac41c3] hover:underline">Gigi De La Ro</a> from <a href="https://pixabay.com" target="_blank" rel="noopener noreferrer" className="text-[#ac41c3] hover:underline">Pixabay</a>.
            </p>
            <p>
