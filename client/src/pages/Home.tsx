    ...
    <Layout>
      ...
      <div className="px-6 pt-6 pb-4 space-y-4 bg-[#0c0c1d] rounded-t-[2.5rem] -mt-6 relative z-10">
        ...
        <div className="flex justify-center gap-6 pt-2 pb-2">
          <a href="https://www.instagram.com/olfly.app/" target="_blank" rel="noopener noreferrer" aria-label="Follow Olfly on Instagram" className="text-white/40 hover:text-[#ac41c3] transition-colors">
          ...
          <a href="https://www.facebook.com/profile.php?id=61580709514176" target="_blank" rel="noopener noreferrer" aria-label="Follow Olfly on Facebook" className="text-white/40 hover:text-[#ac41c3] transition-colors">
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          ...
          <a href="https://www.linkedin.com/company/olfly-app" target="_blank" rel="noopener noreferrer" aria-label="Follow Olfly on LinkedIn" className="text-white/40 hover:text-[#ac41c3] transition-colors">
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
